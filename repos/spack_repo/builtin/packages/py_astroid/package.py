...
class PyAstroid(PythonPackage):
    ...
    version("3.3.10", sha256="c332157953060c6deb9caa57303ae0d20b0fbdb2e59b4a4f2a6ba49d0a7961ce")
    ...
    depends_on("python@3.9:", when="@3.3.10:", type=("build", "run"))
    depends_on("py-lazy-object-proxy", when="@2", type=("build", "run"))
    ...
    depends_on("py-lazy-object-proxy@1.4.0:", when="@2.7.3:2", type=("build", "run"))
    ...
    depends_on("py-wrapt@1.11:1", when="@2.12.7:2 ^python@:3.10", type=("build", "run"))
    ...
    depends_on("py-setuptools@20:", when="@2.7.3:", type="build")
    depends_on("py-setuptools@62.6:62", when="@2.12.7:2", type="build")
    depends_on("py-setuptools@77:", when="@3.3.10:", type="build")
