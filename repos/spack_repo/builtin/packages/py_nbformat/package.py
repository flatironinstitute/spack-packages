...
class PyNbformat(PythonPackage):
    ...
    depends_on("python@3.8:", when="@5.9:", type="build")
    depends_on("python@3.7:", when="@5.2:", type="build")
    depends_on("py-hatchling@1.5:", when="@5.6:", type="build")
    depends_on("py-hatch-nodejs-version", when="@5.6:", type="build")

    depends_on("py-fastjsonschema@2.15:", when="@5.10.4:", type=("build", "run"))
    ...
    depends_on("py-jupyter-core@4.12:", when="@5.10.4:", type=("build", "run"))
    ...
    depends_on("py-importlib-metadata@3.6:", when="@5.7:5.8 ^python@:3.7", type=("build", "run"))
