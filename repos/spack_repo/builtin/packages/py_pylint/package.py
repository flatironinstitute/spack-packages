...
class PyPylint(PythonPackage):
    ...
    version("3.3.4", sha256="74ae7a38b177e69a9b525d0794bd8183820bfa7eb68cc1bee6e8ed22a42be4ce")
    ...
    depends_on("python@3.9.0:", when="@3.3.7:", type=("build", "run"))
    depends_on("py-setuptools-scm", when="@2.8.2", type="build")
    depends_on("py-setuptools@17.1:", type="build")
    depends_on("py-setuptools@62.6:62", when="@2.15.0:2", type="build")
    depends_on("py-setuptools@77:", when="@3.3.7:", type="build")
    depends_on("py-wheel@0.37.1:0.37", when="@2.15.0:2", type="build")
    ...
    depends_on("py-dill@0.3.7:", when="@2.16.0: ^python@3.12:", type=("build", "run"))
