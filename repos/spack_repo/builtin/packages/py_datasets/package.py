...
class PyDatasets(PythonPackage):
    ...
    version("5.0.1", sha256="ce22bb851efd7494f08aad33b940803784434f6e77763d00679a0dc45fcf686a")
    ...
    with default_args(type=("build", "run")):
        ...
        depends_on("py-dill@0.3.0:0.4.2", when="@5.0.1")
        depends_on("py-dill@0.3.0:0.3.8", when="@2.20:3.2")
        ...
        depends_on("py-multiprocess@:0.70.20", when="@5")
        depends_on("py-multiprocess@:0.70.16", when="@3")
        depends_on("py-multiprocess")
        depends_on("py-fsspec@2023.1:2026.6.0+http", when="@5")
        depends_on("py-fsspec@2023.1:2024.9.0+http", when="@3")
        ...
        depends_on("py-huggingface-hub@0.25:", when="@5")
        depends_on("py-huggingface-hub@0.23:", when="@3")
