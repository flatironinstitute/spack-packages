...
class PyNbodykit(PythonPackage):
    ...
    pypi = "nbodykit/nbodykit-0.3.16.tar.gz"

    # 0.3.16 sdist was cut from exactly the commit pinned below
    version("0.3.16", sha256="f70c1c1a98aa671bfcd29e59b99e1636196e4e83c00a3b04741bf079695d172b")
