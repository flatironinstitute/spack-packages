...
class PyJupyterhub(PythonPackage):
    ...
    version("5.5.1", sha256="07f2e4a891cd767203b66b00a8f113d7033ddfc109aaa0ee43e70ae24f72659e")
    ...
    depends_on("py-idna", type=("build", "run"), when="@5:")
    ...
    depends_on("py-jupyter-events", type=("build", "run"), when="@5:")
    ...
    depends_on("py-pamela@1.1:", type=("build", "run"), when="@5:")
    depends_on("py-prometheus-client@0.5.0:", type=("build", "run"), when="@5:")
    depends_on("py-prometheus-client@0.4.0:", type=("build", "run"), when="@1.4.1:")
    depends_on("py-prometheus-client@0.0.21:", type=("build", "run"))
    depends_on("py-psutil@5.6.5:", when="@5:", type=("build", "run"))
    depends_on("py-pydantic", type=("build", "run"), when="@5:")
    ...
    depends_on("py-sqlalchemy@1.4.1:", type=("build", "run"), when="@5:")
